...
folders = ['transaction-data', 'customer-profiles', 'fraudulent-patterns', 'transaction-amounts', 'merchant-info']
...
transaction_records.to_csv('transaction-data/transaction_records.csv', index=False)
transaction_metadata.to_csv('transaction-data/transaction_metadata.csv', index=False)
customer_data.to_csv('customer-profiles/customer_data.csv', index=False)
account_activity.to_csv('customer-profiles/account_activity.csv', index=False)
fraud_indicators.to_csv('fraudulent-patterns/fraud_indicators.csv', index=False)
suspicious_activity.to_csv('fraudulent-patterns/suspicious_activity.csv', index=False)
amount_data.to_csv('transaction-amounts/amount_data.csv', index=False)
anomaly_scores.to_csv('transaction-amounts/anomaly_scores.csv', index=False)
merchant_data.to_csv('merchant-info/merchant_data.csv', index=False)
transaction_category_labels.to_csv('merchant-info/transaction_category_labels.csv', index=False)